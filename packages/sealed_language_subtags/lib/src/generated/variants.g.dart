...
const List<Variant> variants = [
  ...
  Variant(
      subtag: 'heploc',
      descriptions: ['Hepburn romanization, Library of Congress method'],
      added: '2009-10-01',
      deprecated: '2010-02-07',
      preferredValue: 'alalc97',
  ...
  Variant(
      ...
      prefixes: ['en']),
  Variant(
      subtag: 'simple', descriptions: ['Simplified form'], added: '2015-12-29'),
  Variant(
      subtag: 'slepe',
